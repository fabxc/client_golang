...
const (
	...
	// The legacy label name indicating the metric name of a timeseries. This is
	// still needed to translate from and to the legacy JSON formats.
	LegacyMetricNameLabel LabelName = "name"
